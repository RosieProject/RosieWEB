...
namespace Rosie
{
    public class Usuario
    {
        ...
        public static Usuario Criar(string login, string nome, string password)
        {
            ...
            using (SqlConnection conn = new SqlConnection("Server=tcp:luizcarlos.database.windows.net,1433;Initial Catalog=Meu_Primeiro_banco_de_dados;Persist Security Info=False;User ID=luizca95;Password=Monforte1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"))
            {
